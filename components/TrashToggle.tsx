...
const styles = StyleSheet.create({
  row: {
    ...
    backgroundColor: '#fff', borderRadius: 14, padding: 16, marginVertical: 6,
  },
  labelWrap: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  icon: { fontSize: 18 },
  label: { fontSize: 15, fontWeight: '700', color: '#3f4c2c' },
  ...
  knobText: { color: '#3fae5a', fontSize: 14, fontWeight: '900' },
});